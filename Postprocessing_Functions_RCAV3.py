...
def ContinuousRotatingCoilAnalysis (datafile, p_turn, knAbs, knCmp, MagOrder, Rref, AnalysisOptions,step,skew):
...
# =============================================================================       
        [Norm_cmp,
         ...
         x,
         y,
         PhiOut]=RotatingCoilAnalysisTurn(Fabs, Fcmp, knAbs, knCmp, MagOrder, Rref, AnalysisOptions,skew)
# =============================================================================
#         Analysis of each turn
# =============================================================================       
...
# =============================================================================
    ...
    Header_ave.index=["position","Rref [m]","x [m]","y [m]","Angle [red]"]
...
def RotatingCoilAnalysisTurn(Fabs, Fcmp, knAbs, knCmp, MagOrder, Rref, AnalysisOptions,skew):
